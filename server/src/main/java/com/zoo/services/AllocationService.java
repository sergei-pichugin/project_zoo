...
public class AllocationService {
    ...
    public int putPairs(List<Tuple> pairs,
        ...
        for (int i = 0; i < Math.min(aviariesCount, pairs.size()); i++) {
            ...
            Long animalId1 = (Long) pair.get("firstAnimal");
            if (animalInAviaryMap.get(animalId1) == null) continue;

            Long animalId2 = (Long) pair.get("secondAnimal");
            if (animalInAviaryMap.get(animalId2) == null) continue;
